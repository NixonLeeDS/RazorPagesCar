...
namespace RazorPagesCar.Pages.Roles
{
    ...
    public class ManageModel : PageModel
    {
        ...
        public ManageModel(RazorPagesCar.Models.RazorPagesCarContext context, UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync(string selectedusername, string selectedrolename)
        {
            ...
            if (roleResult.Succeeded)
            {
                ...
                auditrecord.AuditActionType = "managed role";
                auditrecord.DateTimeStamp = DateTime.Now;
                auditrecord.KeyMovieFieldID = 12;
